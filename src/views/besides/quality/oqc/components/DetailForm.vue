<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="80%">
    ...
    <el-descriptions title="检测信息" :column="2" :size='size' border>
      <el-descriptions-item label="检验模板ID" align="center">{{ formData.templateId }}</el-descriptions-item>
      <el-descriptions-item label="发货数量" align="center">{{ formData.quantityOut }}</el-descriptions-item>
      ...
      <el-descriptions-item label="合格数量" align="center">{{ formData.quantityQuanlified }}</el-descriptions-item>
      <el-descriptions-item label="本次检测数量" align="center">{{ formData.quantityCheck }}</el-descriptions-item>
    </el-descriptions>
    ...
    <el-descriptions title="结果" :column="2" :size='size' border>
      ...
      <el-descriptions-item label="出货日期" align="center">{{ formData.outDate }}</el-descriptions-item>

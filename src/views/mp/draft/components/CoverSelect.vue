<template>
  <div>
    <p>封面:</p>
    <div class="thumb-div">
      <el-image v-if="newsItem.thumbUrl" fit="contain" :src="newsItem.thumbUrl" style="width: 300px; max-height: 300px" />
      <Icon v-else class="avatar-uploader-icon" :class="isFirst ? 'avatar' : 'avatar1'" icon="ep:plus" />
      <div class="thumb-but">
        <el-upload
          :action="UPLOAD_URL"
        ...
        >
          ...
          <el-button size="small" style="margin-left: 5px" type="primary" @click="showImageDialog = true">素材库选择</el-button>
          <template #tip>

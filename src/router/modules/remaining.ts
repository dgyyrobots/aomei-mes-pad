...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: '/production',
        component: () => import('/@/views/besides/production.vue'),
        name: 'production',
        meta: {
          title: '生产',
          // title: t('router.home'),
      ...
      {
        path: '/equipment',
        component: () => import('/@/views/besides/equipment.vue'),
        name: 'equipment',
        meta: {
          title: '设备',
          // icon: 'home-2-line',
      ...
      },
      {
        ...
        children: [
          {
            path: '/iqc',
            component: () => import('/@/views/besides/quality/iqc/index.vue'),
            name: 'iqc',
            meta: {
              title: '来料',
              // icon: 'home-2-line',
          ...
          {
            path: '/oqc',
            component: () => import('/@/views/besides/quality/oqc/index.vue'),
            name: 'oqc',
            meta: {
              title: '出库',
              // icon: 'home-2-line',
      ...
      },
      {
        ...
        component: () => import('/@/views/besides/quotationRecord.vue'),
      ...
      {
        path: '/report',
        component: () => import('/@/views/besides/report.vue'),
        name: 'report',
        meta: {
          title: '报工',
          // icon: 'home-2-line',

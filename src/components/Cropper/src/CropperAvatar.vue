<template>
  <div class="user-info-head" @click="open()">
    <el-avatar v-if="sourceValue" alt="avatar" class="img-circle img-lg" :src="sourceValue" />
    <el-avatar v-if="!sourceValue" alt="avatar" class="img-circle img-lg" :src="avatar" />
    <el-button v-if="showBtn" :class="`${prefixCls}-upload-btn`" @click="open()">
      {{ btnText ? btnText : t('cropper.selectImage') }}
    </el-button>
    <copper-modal ref="cropperModelRef" :src-value="sourceValue" @upload-success="handleUploadSuccess" />
  </div>
</template>
